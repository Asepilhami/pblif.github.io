    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Dokumen P4M</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tim P4M </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Struktur organisasi SPMI Polibatam</h5>
              <a><b>Kepala Pusat Pengembangan Pembelajaran dan Penjaminan Mutu :</b>
              <br>Evaliata BR.Sembiring, S.Kom, M.Cs </a>
               <br></br>   
               <a><b>Staf Pusat Pengembangan Pembelajaran dan Penjaminan Mutu :</b>
               <br>  Fatima Akmal Putri, S.T
               <br>  Lidya Mariska , S.Tr.Ab
               <br>  M.Fadli Kumangki, S.Tr.Kom
               <br>  Titin Sumarni, S.Tr.Ak</a>
            </div>
            </div>
