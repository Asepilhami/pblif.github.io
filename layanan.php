...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-toggle="modal" data-bs-target="#out">
          <i class="bi bi-gem"></i><span>Logout</span>
        </a>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="Layanan.php">Standar Layanan</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">: Standar Layanan</div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <select class="form-select" aria-label="Default select example"
              ...
              <option value="layanan/k4.1.php">4.1 Standar Layanan Administrasi Mahasiswa Dan Lulusan</option>
              <option value="layanan/k4.2.php">4.2 Standar Layanan Perpustakaan</option>
              <option value="layanan/k4.3.php">4.3 Standar Layanan Kepegawaian</option>
              <option value="layanan/k4.4.php">4.4 Standar Layanan Perencanaan Anggaran</option>
              <option value="layanan/k4.5.php">4.5 Standar Layanan Keuangan</option>
              <option value="layanan/k4.6.php">4.6 Standar Layanan Sistem Informasi</option>
              <option value="layanan/k4.7.php">4.7 Standar Layanan Pengadaan</option>
              <option value="layanan/k4.8.php">4.8 Standar Layanan Pengelolaan Aset Dan Persediaan</option>
              <option value="layanan/k4.9.php">4.9 Standar Layanan Perawatan Dan Perbaikan</option>
              <option value="layanan/k4.10.php">4.10 Standar Layanan Humas</option>
              <option value="layanan/k4.11.php">4.11 Standar Layanan Administrasi Umum</option>
            </select>
          </div>
        </div>
      </div>
