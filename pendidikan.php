    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="pendidikan.php">Standar Pendidikan</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">: Standar Pendidikan</div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <select class="form-select" aria-label="Default select example"
              ...
              <option value="Forms_pendidikan\k1.1.php">1.1Standar Pengelolaan Institusi</a> </option>
              <option value="Forms_pendidikan\k1.2.php">1.2 Standar Pengelolaan Program</option>
              <option value="Forms_pendidikan\k1.3.php">1.3 Standar Penerimaan Mahasiswa</option>
              <option value="Forms_pendidikan\k1.4.php">1.4 Standar Layanan kemahasiswaan</option>
              <option value="Forms_pendidikan\k1.5.php">1.5 Standar Dosen</option>
              <option value="Forms_pendidikan\k1.6.php">1.6 Standar Tenaga Kependidikan</option>
              <option value="Forms_pendidikan\k1.7.php">1.7 Standar Pembiayaan Pembelajaran</option>
              <option value="Forms_pendidikan\k1.8.php">1.8 Standar Sarana dan Prasarana</option>
              <option value="Forms_pendidikan\k1.9.php">1.9 Standar Kompetensi Lulusan</option>
              <option value="Forms_pendidikan\k1.10.php">1.10 Standar Isi Pembelajaran</option>
              <option value="Forms_pendidikan\k1.11.php">1.11 Standar Proses Pembelajaran</option>
              <option value="Forms_pendidikan\k1.12.php">1.12 Standar Penilaian Pembelajaran</option>
              <option value="Forms_pendidikan\k1.13.php">1.13 Standar Evaliasi Pembelajaran</option>
              <option value="Forms_pendidikan\k1.14.php">1.14 Standar Pengelola Dokumen Mutu</option>
              <option value="forms_pendidikan\k1.15.php">1.15 Standar Kerjasama</option>
              <option value="forms_pendidikan\k1.16.php">1.16 Standar Prestasi Mahasiswa</option>
              <option value="forms_pendidikan\k1.17.php">1.17 Standar Lulusan dan Pelacakan Alumni</option>
              <option value="forms_pendidikan\k1.18.php">1.18 Standar Peningkatan Standar</option>
            </select>
          </div>
        </div>
      </div>
