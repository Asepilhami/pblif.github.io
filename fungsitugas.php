    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">fungsi dan tugas </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="row">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Fungsi P4M Antara Lain :</h5>
                1. Fungsi Melaksanakan dan Mengkoordinasikan kegiatan Penjaminan Mutu
                <br>2. Fungsi Melaksanakan administrasi Unit Penjaminan Mutu
                <br>3. Fungsi Melaksanakan fungsi penjaminan mutu pendidikan, penelitian, dan pengabdian kepada
                masyarakat serta seluruh unit penunjang
                <br>4. Fungsi Menyelenggarakan fungsi pengembangan sistem penjaminan mutu dengan merencanakan dan
                mengusulkan pegembangan Penjaminan Mutu
                <br>5. Fungsi Melaksanakan kegiatan insidental tahunan Penjaminan Mutu</a>
              </div>
            </div>
