...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1> <i class="bi bi-person"></i>Management User</h1>
    ...
    <div class="card">
      ...
      <h2>Form Pendaftaran Akun</h2>
        <form method="POST" action="API\proses_pendaftaran.php">
            <div class="form-group">
                <label for="nama">Nama:</label><br>
                <input type="text"  class="col col-md-2" id="nama" name="nama" required>
            </div>
            <div class="form-group">
                <label for="role">Role:</label><br>
                <input type="text"  class="col col-md-2" id="role" name="role" required>
            </div>
            <div class="form-group">
                <label for="email">Email:</label><br>
                <input type="email"  class="col col-md-2" id="email" name="email" required>
            </div>
            <div class="form-group">
                <label for="username">Username:</label><br>
                <input type="text"  class="col col-md-2" id="username" name="username" required>
            </div>
            <div class="form-group">
                <label for="password">Password:</label><br>
                <input type="password" class="col col-md-2" id="password" name="password" required>
            </div>
