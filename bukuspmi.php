    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Buku SPMI </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Download Buku Pedoman SPMI Polibatam</h5>
              <a href="/pbl33-spmi/assets/dokumen/Buku SPMI ed.3 Tahun 2021.pdf" download>Unduh PDF</a>
            </div>
            </div>
