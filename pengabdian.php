        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <select class="form-select" aria-label="Default select example"
              ...
              <option value="pengabdian\k3.6.php">3.6 Standar Sarana dan Prasarana Pengabdian Kepada Masyarakat</option>
              <option value="pengabdian\k3.7.php">3.7 Standar Pengelolaan Pengabdian Kepada Masyarakat</option>
              <option value="pengabdian\k3.8.php">3.8 Standar Pendanaan dan Pembiayaan Pengabdian KepadaMasyarakat</option>
            </select>
          </div>
        </div>
      </div>
