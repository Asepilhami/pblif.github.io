    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Pedoman Bisnis </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Download 01. Manual Mutu</h5>
                <a href="/pbl33-spmi/assets/dokumen/MM-V2 Manual Mutu Politeknik Negeri Batam.pdf" download>Unduh
                  PDF</a>
              </div>
              <div class="card-body">
                <h5 class="card-title">Download 02. Kalender Mutu 2020</h5>
                <a href="/pbl33-spmi/assets/dokumen/Kalender Mutu 2020.xlsx" download>Unduh excel</a>
              </div>
              <div class="card-body">
                <h5 class="card-title">Download 03. Kepemilikan dokumen mutu (borang)</h5>
                <a href="/pbl33-spmi/assets/dokumen/No.MT.34.6.1-V2 Borang PM - Pemilik Dokumen.pdf" download>Unduh
                  PDF</a>
              </div>
              <div class="card-body">
                <h5 class="card-title">Download 04. Target Mutu</h5>
                <a href="/pbl33-spmi/assets/dokumen/.pdf" download>Unduh PDF</a>
              </div>
            </div>
