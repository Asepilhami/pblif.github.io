    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Pedoman Internal </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Download Pedoman Pengembangan Kurikulum</h5>
                <a href="/pbl33-spmi/assets/dokumen/Pengembangan Kurikulum u-merged.pdf" download>Unduh PDF</a>
              </div>
              <div class="card-body">
                <h5 class="card-title">Download Pedoman Merdeka Belajar</h5>
                <a href="/pbl33-spmi/assets/dokumen/Pedoman Merdeka Belajar v5 tanpa kata pengantar.pdf" download>Unduh
                  PDF</a>
              </div>
              <div class="card-body">
                <h5 class="card-title">Download Pedoman Panduan PBL Jurusan Informatika</h5>
                <a href="/pbl33-spmi/assets/dokumen/Panduan PBL Jurusan Teknik Informatika Tahun 2021 v2.1.pdf"
                  download>Unduh PDF</a>
              </div>
            </div>
