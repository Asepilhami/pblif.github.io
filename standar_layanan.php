    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">standar layanan </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Download Standar Layanan Polibatam</h5>
              <a href="/pbl33-spmi/assets/dokumen/Standar Layanan Polibatam.pdf" download>Unduh PDF</a>
            </div>
            </div>
